// Run via: playwright-cli run-code --filename dump_dom.js
// Extracts all visible elements with X-relevant attributes. Logs JSON to stdout.
async (page) => {
...
console.log('DOMDUMP::' + JSON.stringify(data));
