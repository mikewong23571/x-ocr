...
> 目标源：[task_spec.md](task_spec.md) · 验收台账：[goal.md](goal.md) · **v1.2 终版**（+light 主题批次 134 张、exp008 A100、双主题闭环）
...
| 问题 | 答案 |
|---|---|
| 最终用了多少 screenshot？ | **645 张**（22 个采集 session s01–s22：4 种 viewport × 7 route × 菜单/弹窗/线程/通知状态；dark 511 + **light 134**）|
| 多少 UI element instance？ | **40,914 个标注实例**（30 类，无零样本类）|
...
| 645（exp008，+134 light，A100） | nano **.932/.872**（mAP50-95 +1.2pt） | 暗色无损 + light 召回 2.4%→91.9% |
